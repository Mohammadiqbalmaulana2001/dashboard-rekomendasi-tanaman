...
label_mapping = {
    0: 'padi', 1: 'jagung', 2: 'buncis', 3: 'kacang merah', 4: 'kacang polong',
    5: 'kacang panjang', 6: 'kacang hijau', 7: 'lentil hitam', 8: 'lentil',
    9: 'delima', 10: 'pisang', 11: 'mangga', 12: 'anggur', 13: 'semangka',
    14: 'melon', 15: 'apel', 16: 'jeruk', 17: 'pepaya', 18: 'kelapa',
    19: 'kapas', 20: 'kopi'
}
...
if st.button("🔎 Prediksi Tanaman"):
    ...
    predicted_label = label_predict.get(prediksi, "Tanaman Tidak Dikenal")
